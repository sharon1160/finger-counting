...
while True:
    ...
    if (len(handLandmarks) != 0):
        ...
        if handLandmarks[4][3] == "Right" and handLandmarks[4][
                1] > handLandmarks[3][1]:  #Right Thumb
            count = count + 1
        elif handLandmarks[4][3] == "Left" and handLandmarks[4][
                1] < handLandmarks[3][1]:  #Left Thumb
            count = count + 1
    ...
    cv2.putText(image, str(count), (45, 375), cv2.FONT_HERSHEY_SIMPLEX, 5,
                (255, 0, 0), 25)
